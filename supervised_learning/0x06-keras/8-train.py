...
model"""
    ...
    if validation_data and early_stopping:
        ...
        callbcks.append(K.callbacks.EarlyStopping(monitor='val_loss',
                                                  patience=patience,
                                                  mode="min"))
    if validation_data and learning_rate_decay:
        ...
        callbcks.append(K.callbacks.LearningRateScheduler(scheduler,
                                                          verbose=1))
    if save_best:
        callbcks.append(K.callbacks.ModelCheckpoint(filepath,
                                                    save_best_only=True))
